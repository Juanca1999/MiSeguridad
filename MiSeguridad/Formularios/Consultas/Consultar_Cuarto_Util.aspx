<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Maestras/Maestra.Master" CodeBehind="Consultar_Cuarto_Util.aspx.vb" Inherits="MiSeguridad.Consultar_Cuarto_Util" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #0442A6 !important;">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-center w-100 position-relative">
                <span class="navbar-brand" style="font-weight: bold; font-size: 24px; color: white;">CONSULTAS - CONSULTAR CUARTO UTIL</span>
            </div>
                ...
                <div class="row" style="padding-top: 0px; margin-top: 0px;">
                    ...
                    <div class="col-md-12 mb-3" style="display: flex; justify-content: center; padding-bottom: 7%; padding-top: 3%;">
                        <div class="icon has-float-label">
                            <label class="cd-label" for="TxBuscarCuartoUtil" style="font-size: 12pt; font-weight: bold;">Buscar Cuarto Util</label>
                            <asp:TextBox ID="TxBuscarCuartoUtil" runat="server" CssClass="Buscar" AutoPostBack="true" Width="90%"></asp:TextBox>
                        </div>
                        <asp:Button ID="BtBuscarCuartoUtil" runat="server" Text="BUSCAR" CssClass="btn btn-outline-primary" Style="background-color: #1e2833; border-color: #1e2833; padding: 15px 20px;" />
                    </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server" style="margin-top: -15px;" UpdateMode="always">
                                <ContentTemplate>
                                    <asp:ListView ID="LvImuebles" runat="server" DataSourceID="SqlInmueble">
                                        ...
                                        <ItemTemplate>
                                            <tr style="">
                                                ...
                                                <td style="width: 1%; text-align: center; vertical-align: middle; border: solid; border-width: 1px; border-color: lightgray; padding: 5px;">
                                                    <asp:Label ID="Id_Cuarto_UtilLabel" runat="server" Text='<%# Eval("Id_Cuarto_Util") %>' Font-Size="10pt" />
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                                    ...
                                                    <td runat="server">
                                                        <table id="itemPlaceholderContainer" runat="server" border="0" style="width: 100%">
                                                            <tr runat="server">
                                                                ...
                                                                <th runat="server" style="border: thin solid #FFFFFF; padding: 5px; vertical-align: middle; text-align: center; width: 20%; background-color: #1e2833; color: white; font-size: 10pt; height: 30px">CUARTO UTIL</th>
                                                            </tr>
                                    ...
                                    <asp:SqlDataSource ID="SqlInmueble" runat="server" ConnectionString="<%$ ConnectionStrings:MiSeguridadConnectionString %>" SelectCommand="SELECT I.Id_inmueble, I.Id_Tipo_Inmueble, T.Tipo_Inmueble, I.Telefono, IC.Id_Cuarto_Util FROM Adm_Inmueble I LEFT JOIN Adm_Tipo_Inmueble T ON T.Id_Tipo_Inmueble = I.Id_Tipo_Inmueble LEFT JOIN Adm_Inmueble_Cuarto_Util IC ON IC.Id_Inmueble = I.Id_inmueble WHERE IC.Id_Cuarto_Util = @CuartoUtil ORDER BY IC.Id_Cuarto_Util">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="TxBuscarCuartoUtil" Name="CuartoUtil" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </ContentTemplate>
                            </asp:UpdatePanel>
