...
Partial Public Class Consultar_Visitantes_Inmueble
    ...
    '''<summary>
    '''Control BtBuscarInmueble.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents BtBuscarInmueble As Global.System.Web.UI.WebControls.Button
