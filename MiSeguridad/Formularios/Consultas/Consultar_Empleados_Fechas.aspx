<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Maestras/Maestra.Master" CodeBehind="Consultar_Empleados_Fechas.aspx.vb" Inherits="MiSeguridad.Consultar_Empleados_Fechas" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #0442A6 !important;">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-center w-100 position-relative">
                <span class="navbar-brand" style="font-weight: bold; font-size: 24px; color: white;">CONSULTAS - CONSULTAR EMPLEADOS SIN SALIDA POR FECHA</span>
            </div>
                ...
                <div class="row" style="padding-top: 0px; margin-top: 0px;">
                    ...
                    <div class="col-md-12 mb-3" style="display: flex; justify-content: center; padding-bottom: 5%; padding-top: 3%;">
                        <div class="icon has-float-label">
                            <label class="cd-label" for="TxFechaInicio" style="font-size: 12pt; font-weight: bold;">Fecha Inicio</label>
                            <asp:TextBox ID="TxFechaInicio" runat="server" TextMode="Date" CssClass="Fecha" AutoPostBack="true" Width="90%"></asp:TextBox>
                        </div>
                        <div class="icon has-float-label">
                            <label class="cd-label" for="TxFechaFin" style="font-size: 12pt; font-weight: bold;">Fecha Fin</label>
                            <asp:TextBox ID="TxFechaFin" runat="server" TextMode="Date" CssClass="Fecha" AutoPostBack="true" Width="90%"></asp:TextBox>
                        </div>
                        <asp:Button ID="BtBuscarFecha" runat="server" Text="BUSCAR" CssClass="btn btn-outline-primary" Style="background-color: #1e2833; border-color: #1e2833; padding: 15px 20px;" />
                    </div>
                    ...
                    <div id="Tabla" runat="server" class="col-md-12 mb-3" visible="false">
                        ...
                        <div class="row mb-3" style="text-align: center;">
                            <div class="col-md-8">
                                <asp:Label ID="Titulo2Label" runat="server" Text="Empleados" Font-Size="X-Large" ForeColor="Black" Font-Names="Trebuchet MS" Width="280px"></asp:Label>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                                    <ContentTemplate>
                                        <asp:Button ID="BtSalidaMasiva" runat="server" Text="SALIDA MASIVA" Enabled="false" CssClass="btn btn-outline-primary" Style="background-color: #1e2833; border-color: #1e2833; padding: 15px 20px;" data-toggle="modal" data-target="#Salir" />
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                            </div>
                        </div>
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" style="margin-top: -15px;" UpdateMode="always">
                                <ContentTemplate>
                                    ...
                                    <asp:SqlDataSource ID="SqlEmpleados" runat="server" ConnectionString="<%$ ConnectionStrings:MiSeguridadConnectionString %>" SelectCommand="SELECT V.Id_Visita, T.Cedula, T.Nombres, V.Fecha_Inicio_Visita, V.Hora_Inicio_Visita, V.Fecha_Fin_Visita, Hora_fin_Visita, CASE WHEN V.Estado = 1 THEN 'EN CURSO' ELSE 'FINALIZADA' END Estado FROM Adm_Visita V LEFT JOIN Terceros T ON T.Id_Tercero = V.Id_Quien_Ingresa WHERE V.Estado = 1 AND T.Id_Rol = 8 AND V.Fecha_Inicio_Visita BETWEEN @Fecha_Inicio AND @Fecha_Fin ORDER BY V.Fecha_Inicio_Visita DESC">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="TxFechaInicio" Name="Fecha_Inicio" PropertyName="Text" />
                                            <asp:ControlParameter ControlID="TxFechaFin" Name="Fecha_Fin" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </ContentTemplate>
                            </asp:UpdatePanel>
        ...
        <div class="modal-dialog" role="document" style="text-align: center">
            <div class="modal-content" style="text-align: center">
                <div class="modal-header" style="text-align: center">
                    <h5 class="modal-title" style="text-align: center">REGISTRAR SALIDA MASIVA</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" style="text-align: center">
                    <asp:Label ID="Label3" runat="server" Text="¿Seguro que desea registrar la salida masiva de las fechas seleccionadas?"></asp:Label>
