<%@ Page Language="vb" AutoEventWireup="false" EnableEventValidation="false" MasterPageFile="~/Maestras/Maestra.Master" CodeBehind="Consultar_Empleados_Cedula.aspx.vb" Inherits="MiSeguridad.Consultar_Empleados_Cedula" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #0442A6 !important;">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-center w-100 position-relative">
                <span class="navbar-brand" style="font-weight: bold; font-size: 24px; color: white;">CONSULTAS - CONSULTAR EMPLEADOS GENERAL POR CEDULA</span>
            </div>
                ...
                <div class="row" style="padding-top: 0px; margin-top: 0px;">
                    ...
                    <div class="col-md-12 mb-3" style="display: flex; justify-content: center; padding-bottom: 5%; padding-top: 3%;">
                        <div class="icon has-float-label">
                            <label class="cd-label" for="TxBuscarCedula" style="font-size: 12pt; font-weight: bold;">Buscar Cedula</label>
                            <asp:TextBox ID="TxBuscarCedula" runat="server" CssClass="Buscar" AutoPostBack="true" Width="90%"></asp:TextBox>
                        </div>
                        <asp:Button ID="BtBuscarCedula" runat="server" Text="BUSCAR" CssClass="btn btn-outline-primary" Style="background-color: #1e2833; border-color: #1e2833; padding: 15px 20px;" />
                    </div>
                    ...
                    <div id="Tabla" runat="server" class="col-md-12 mb-3" visible="false">
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <div style="display: flex; justify-content: center; align-items: center; width: 100%;">
                                    <asp:Label ID="CedulaLabel" runat="server" Text="" Font-Size="X-Large" ForeColor="Black" Font-Names="Trebuchet MS" Width="180px"></asp:Label><asp:Label ID="NombreLabel" runat="server" Text="" Font-Size="X-Large" ForeColor="Black" Font-Names="Trebuchet MS" Width="380px" Style="text-align: center"></asp:Label>
                        ...
                        <div class="row mb-3" style="text-align: center;">
                            <div class="col-md-10">
                                <asp:Label ID="Titulo2Label" runat="server" Text="Visitas" Font-Size="X-Large" ForeColor="Black" Font-Names="Trebuchet MS" Width="280px"></asp:Label>
                            </div>
                            <div class="col-md-2">
                            ...
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server" style="margin-top: -15px;" UpdateMode="always">
                                <ContentTemplate>
                                    ...
                                    <asp:SqlDataSource ID="SqlEmpleados" runat="server" ConnectionString="<%$ ConnectionStrings:MiSeguridadConnectionString %>" SelectCommand="SELECT V.Id_Visita, T.Cedula, T.Nombres, V.Fecha_Inicio_Visita, V.Hora_Inicio_Visita, V.Fecha_Fin_Visita, Hora_fin_Visita, CASE WHEN V.Estado = 1 THEN 'EN CURSO' ELSE 'FINALIZADA' END Estado FROM Adm_Visita V LEFT JOIN Terceros T ON T.Id_Tercero = V.Id_Quien_Ingresa WHERE T.Cedula = @Persona AND T.Id_Rol = 8 ORDER BY V.Fecha_Inicio_Visita DESC">
                                        <SelectParameters>
                                            <asp:ControlParameter ControlID="TxBuscarCedula" Name="Persona" PropertyName="Text" />
                                        </SelectParameters>
                                    </asp:SqlDataSource>
                                </ContentTemplate>
                            </asp:UpdatePanel>
