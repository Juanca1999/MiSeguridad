...
Public Class Consultar_Placa
    ...
    Private Sub BtBuscarPlaca_Click(sender As Object, e As EventArgs) Handles BtBuscarPlaca.Click
        If TxBuscarPlaca.Text <> "" Then
            ...
            Dim query As String = "SELECT I.Id_inmueble, I.Id_Tipo_Inmueble, T.Tipo_Inmueble, I.Telefono, IV.Placa FROM Adm_Inmueble I LEFT JOIN Adm_Tipo_Inmueble T ON T.Id_Tipo_Inmueble = I.Id_Tipo_Inmueble LEFT JOIN Adm_Inmueble_Vehiculo IV ON IV.Id_inmueble = I.Id_inmueble WHERE IV.Placa = @Placa ORDER BY IV.Placa"
