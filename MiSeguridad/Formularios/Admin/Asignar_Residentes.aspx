<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Maestras/Maestra.Master" CodeBehind="Asignar_Residentes.aspx.vb" Inherits="MiSeguridad.Asignar_Residentes" %>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light" style="background-color: #0442A6 !important;">
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-center w-100 position-relative">
                <span class="navbar-brand" style="font-weight: bold; font-size: 24px; color: white;">ADMINISTRACION - ASIGNAR RESIDENTES</span>
            </div>
                                    ...
                                    <div class="row" style="padding-top: 0px; margin-top: 0px;">
                                        ...
                                        <div class="col-md-12 mb-3" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 0px; margin-top: 0px;">
                                            <div class="icon has-float-label" style="padding-top: 0px; padding-bottom: 0px; margin-bottom: 10px; margin-top: 0px;">
                                                ...
                                                <asp:TextBox ID="TxCedula" runat="server" placeholder="Cedula" CssClass="Cedula"></asp:TextBox>
                                            </div>
                                        </div>
