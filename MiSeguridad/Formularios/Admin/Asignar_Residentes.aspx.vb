...
Public Class Asignar_Residentes
    ...
    Private Sub Eliminar_Detalle(ByRef index As Integer)
        ...
        Try
            ...
            If Validar_Detalle_Inmueble(Convert.ToInt64(Session("Id_inmueble")), Id_Tercero) Then

                Eliminar_Detalle_Inmueble(Convert.ToInt64(Session("Id_inmueble")), Id_Tercero)
