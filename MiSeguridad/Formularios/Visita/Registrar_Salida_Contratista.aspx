<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Maestras/Maestra.Master" CodeBehind="Registrar_Salida_Contratista.aspx.vb" Inherits="MiSeguridad.Registrar_Salida_Contratista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" style="padding-top: 0px; margin-top: 0px;">
        ...
        <div class="col-md-12 mb-3" style="padding-top: 0px; padding-bottom: 25px; margin-bottom: 0px; margin-top: 0px; padding-right: 0pt; text-align: center">
            ...
            <button id="BtSalidaContratista" runat="server" type="button" class="btn btn-outline-primary" style="width: 200px; height: 30px; font-size: 8pt; border-radius: 5px; margin-left: 10px; margin-right: 10px; margin-bottom: 10px; color: #1e2833; background-color: transparent; border-color: #1e2833;">
                    ...
                    <div class="row" style="padding-top: 0px; margin-top: 0px;">
                        ...
                        <div id="Tabla" runat="server" class="col-md-12 mb-3" visible="false">
                            ...
                            <div class="col-md-12 mb-3" style="margin-top: 35px; text-align: center;">
                                <asp:Label ID="Titulo2Label" runat="server" Text="Contratistas" Font-Size="X-Large" ForeColor="Black" Font-Names="Trebuchet MS" Width="280px"></asp:Label>
                            </div>

                            <div class="col-md-12 mb-3">
                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" style="margin-top: -15px;" UpdateMode="always">
                                    <ContentTemplate>
                                        <asp:ListView ID="LvVisitantes" runat="server" DataSourceID="SqlVisitantesCedula">
                                            <EmptyDataTemplate>
                                        ...
                                        <asp:SqlDataSource ID="SqlVisitantesCedula" runat="server" ConnectionString="<%$ ConnectionStrings:MiSeguridadConnectionString %>" SelectCommand="SELECT V.Id_Visita, T.Cedula, T.Nombres, V.Id_Inmueble, V.Fecha_Inicio_Visita, V.Hora_Inicio_Visita FROM Adm_Visita V LEFT JOIN Terceros T ON T.Id_Tercero = V.Id_Quien_Ingresa WHERE V.Estado = 1 AND T.Cedula = @Cedula ORDER BY T.Nombres">
                                            <SelectParameters>
                                                <asp:ControlParameter ControlID="TxBuscarCedulaContratista" Name="Cedula" PropertyName="Text" />
                                            </SelectParameters>
                                        </asp:SqlDataSource>
